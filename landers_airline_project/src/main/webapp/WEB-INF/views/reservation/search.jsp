	...
	<div class="container fare-container">
		<div align="center">
			<strong><h2><%=info.getDeparture_airport()%>
					...
					<%=info.getArrival_airport()%></h2></strong>
		</div>
		<%
		...
		<ul class="fare-list">
			<div style="width: 100%; text-align: right; margin-right: 0;">
				남은좌석 : <%=dto.getEmptynum() %>석</div>
			<li class="list-item">
				<div class="list-summary">
					<div class="head">
						<span class="tk-num"><%=dto.getFlight_name()%>&nbsp;&nbsp;&nbsp;<img
							src="./images/logo.png" style="width: 70px; height: 30px" /></span>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<div class="chips">
							<form action="seat.do" method="post">
								<input type="hidden" name="flight_id"
									value="<%=dto.getFlight_id()%>"> <input type="hidden"
									name="person_num" value="<%=person_num%>"> <input
									type="hidden" name="departure_date"
									value="<%=dto.getDeparture_date()%>"> <input
									type="hidden" name="arrival_date"
									value="<%=dto.getArrival_date()%>"> <input
									type="hidden" name="departure_airport"
									value="<%=dto.getDeparture_airport()%>"> <input
									type="hidden" name="arrival_airport"
									value="<%=dto.getArrival_airport()%>"> <input
									type="hidden" name="price_A"
									value="<%=price_util.price_numA(dto.getPrice())%>"> <input
									type="hidden" name="price_B"
									value="<%=price_util.price_numB(dto.getPrice())%>"> <input
									type="hidden" name="price_C" value="<%=dto.getPrice()%>">
								<input type="submit" class="btn btn-danger"
									style="background-color: #9A161F" value="예약하기">
							</form>
						</div>
					</div>
					<div class="time">
				...
				</div> </span> <span class="tab-btn grade-default">
					<div class="tab-btn-in">
